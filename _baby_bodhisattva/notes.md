...
The ladder that you don't need when you reach the peak... being bottisattva means dedicating your life not on climbing, but on keeping that ladder in tact, so other people can climb it.

And, also, when needed, patching the ladder, putting large neon signs around it "To enlightement" on it, and sometimes fruitlessly trying to pull people up).

---

The thoughts are images. You cannot think about a person or a thing, your brain doesn't contain that person or a thing within itself. You are just thinking about *your* representation of the thing, which also isn't connected to it. Your thoughts can influence reality to a certain extend, but that doesn't alter the fact that you are just fooling yourself that you are thinking about something, while in reality.

It was then I realized that thoughts don't lead to desires, thoughts *are* desires everything you think about is actually (as we established) an image of the actual thing, followed by the desire for the actual thing to be the same as the image (which it cannot be).
